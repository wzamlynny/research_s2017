...
dataset_path = os.path.join(bnpy.ROOT_PATH, "code/output/")
...
# WE DONT WANT TO FILTER OUT ANY DOCUMENTS
...
#     dataset.getDocTypeCountMatrix().sum(axis=1) < 500))
...
trained_model, info_dict = bnpy.run(
    ...
    nLap=2000, convergeThr=0.01, nBatch=5,
